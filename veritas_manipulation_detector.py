        ...
        self.pattern_sets = [
            ...
            # Анонімна "більшість" або "всі" як авторитет без джерел
            {
                ...
                'patterns': [
                    ...
                    r'(дедалі більше (аналітиків|дослідників|експертів|країн)).{1,80}(сходяться|вважають|визнають|погоджуються|обговорюють)',
                    ...
                    r'(деякі (дослідники|аналітики|експерти)).{1,60}(оцінюють|підрахували|встановили|припускають)',
                    # APPEAL TO UNIVERSALITY — "ніхто не заперечить", "всі знають"
