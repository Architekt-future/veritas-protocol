...
def oracle():
    ...
    try:
        ...
        # ── Media Bias ──
        mb_score   = data.get('media_bias_score', 0) or 0
        mb_verdict = data.get('media_bias_verdict', '')
        mb_signals = data.get('media_bias_signals', [])
        mb_patterns = data.get('media_bias_patterns', [])
