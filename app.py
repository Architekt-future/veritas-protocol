...
def oracle():
    ...
    try:
        ...
        prompt = (
            ...
            "КРИТИЧНО ВАЖЛИВО: Твої знання закінчуються приблизно на початку 2025 року. Все що відбулось після — ти не знаєш. Тому НІКОЛИ не стверджуй що щось або хтось \"не існує\", \"неможливо\", \"вигадано\" — якщо це може стосуватись подій після початку 2025. Якщо в тексті згадано особу, подію або факт який ти не знаєш — просто скажи що не можеш перевірити, а не що це вигадка. Краще недосказати ніж збрехати впевнено.\n"
