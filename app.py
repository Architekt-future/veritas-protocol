...
def compute_influence_tier(result):
    ...
    # Жанровий коефіцієнт — наукові/аналітичні тексти знижують поріг маніпуляції
    # GASLIGHTING і подібні патерни часто є false positives в науковому тексті
    genre = diag.get('genre', '') or ''
    SCIENCE_GENRES = {'SCIENCE', 'TECH', 'ANALYTICS', 'REPORT'}
    if genre in SCIENCE_GENRES:
        manip_score = manip_score * 0.4   # знижуємо вагу — наукова мова схожа на маніпулятивну
        axiom_score = axiom_score * 0.6   # те саме для axiom
