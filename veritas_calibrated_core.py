    ...
    def analyze(self, text: str) -> Dict:
        ...
        # AXIOM GUARD OVERRIDE
            ...
            if _genre == 'ANALYTICS':
                ...
                explanation = 'Текст є вираженням суб\'єктивної думки; оцінюйте аргументи, а не факти'
            elif _genre == 'SATIRE':
                status, verdict = 'VERIFIED', 'САТИРИЧНИЙ КОНТЕНТ'
                explanation = 'Виявлено ознаки сатири або іронії; буквальна інтерпретація може бути хибною'
            else:
