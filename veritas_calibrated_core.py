...
class VeritasCalibratedCore:
    ...
    def __init__(self):
        ...
        self.conflict_pairs = [
            ...
            (['квантовий', 'ентропія', 'термодинаміка', 'фізика', 'математика'],
             ['борщ', 'сметана', 'суп', 'їжа', 'рецепт', 'кухня'], 0.45),
        ...
        self.chaos_indicators = {
            ...
            'emotional_manipulation': ['СРОЧНО', 'шок', 'ужас', 'ви не готові'],
            'social_pressure': ['поділіть', 'підпишіть', 'wake up', 'join the movement'],
            ...
            'political_manipulation': ['ворог народу', 'зрада', 'п\'ята колона'],
    ...
    def _calculate_conflict_penalty(self, text: str) -> Tuple[float, List[LogicalViolation]]:
        ...
        for list1, list2, weight in self.conflict_pairs:
            found_in_first  = [t for t in list1 if t in text_lower]
            found_in_second = [t for t in list2 if t in text_lower]
            ...
            if found_in_first and found_in_second:
                ...
                for sentence in sentences:
                    ...
                    has_first  = any(t in s_lower for t in found_in_first)
                    has_second = any(t in s_lower for t in found_in_second)
